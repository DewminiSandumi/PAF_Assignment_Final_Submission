					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="email" name="email" class="form-control"><span class="pmd-textfield-focused"></span>
								<input button="Search" id="searchEmail" class="form-control"><span class="pmd-textfield-focused"></span>
							</div>
						</div>
					</div>
    </div>
    
    <a input="submit" value="delete" class="btn btn-primary next">Delete</a><!--end content area-->
        <a input="reset"  class="btn btn-primary default">Cancle</a><!--end content area-->
    </form>
