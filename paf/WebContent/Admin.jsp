...
<html lang=""><head>
    ...
    <aside id="basicSidebar" class="pmd-sidebar  sidebar-default pmd-sidebar-left bg-fill-darkblue sidebar-with-icons is-slidepush pmd-sidebar-left-fixed" role="navigation">
        <ul class="nav pmd-sidebar-nav">
            ...
            <li class="dropdown pmd-dropdown open"> 
                <a aria-expanded="true" data-toggle="dropdown" class="btn-user dropdown-toggle media active" data-sidebar="true" href="javascript:void(0);">	
    ...
    <li><a href="ViewUser.jsp" class="active">View User</a></li>
    ...
    <form id="adminForm" action="Admin.do" onsubmit="return passwordMatch()" method="post">
			<div class="pmd-card pmd-z-depth">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="fname" name="fname" class="form-control" required=""><span class="pmd-textfield-focused"></span>
							</div>
						</div>
					</div>
						<div class="pmd-card-body">
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="lname" name="lname" class="form-control" required=""><span class="pmd-textfield-focused"></span>
							</div>
						</div>
					</div>
						<div class="pmd-card-body">
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="date" id="dob" name="dob" class="form-control"><span class="pmd-textfield-focused"></span>
							</div>
						</div>
					</div>
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
							   ...
							   <input type="text" id="mobile" name="mobile" class="form-control"><span class="pmd-textfield-focused"></span>
							</div>
						</div>
						<div class="group-fields clearfix row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
							   ...
							   <input type="text" id="phone" name="phone" class="form-control"><span class="pmd-textfield-focused"></span>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						   <div class="form-group pmd-textfield pmd-textfield-floating-label">
							   ...
							   <input type="email" id="email" name="email" class="form-control"><span class="pmd-textfield-focused"></span>
							</div>
						</div>
					</div>
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
							  ...
							  <textarea  name="PermanentAddress" class="form-control"></textarea><span class="pmd-textfield-focused"></span>
							</div>
						</div>
					</div>
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
							  ...
							  <textarea  name="CurrentAddress" class="form-control"></textarea><span class="pmd-textfield-focused"></span>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						   <div class="form-group pmd-textfield pmd-textfield-floating-label">
							   ...
							   <input type="password" id="password" name="password" class="form-control" required=""><span class="pmd-textfield-focused"></span>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						   <div class="form-group pmd-textfield pmd-textfield-floating-label">
							   ...
							   <input type="password" id="confirmPassword" name="confirmPassword" class="form-control" required=""><span class="pmd-textfield-focused"></span>
							</div>
						</div>
						<script>
						   ...
						   <div class="form-group pmd-textfield pmd-textfield-floating-label">
							   <label for="regular1" class="control-label">
								...
								<select id="UserType" name="UserType" class="select-simple form-control pmd-select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true">
									<option></option>
									<option value="1">Owner</option>
									<option value="2">Admin</option>
									<option value="3">Member</option>
									
								</select><span class="pmd-textfield-focused"></span><span class="select2 select2-container select2-container--bootstrap" dir="ltr" style="width: 236px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-41vk-container"><span class="select2-selection__rendered" id="select2-41vk-container" title=""></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
							</div>
						</div>
				...
				<div class="pmd-card-actions">
					...
					<!--a href="ViewUser" class="btn btn-primary next">Submit</a-->
