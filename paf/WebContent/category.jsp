...
<html lang=""><head>
   ...
   <div class="pmd-sidebar-overlay"></div>
    ...
    <form id="category" action="addCategory.do" method="post">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								...
								<input type="text" id="cname" name="cname" class="form-control" required=""><span class="pmd-textfield-focused"></span>
							</div>
						</div>
					</div>
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
							  ...
							  <textarea required="" id="desc" name="desc" class="form-control"></textarea><span class="pmd-textfield-focused"></span>
							</div>
						</div>
					</div>
					<div class="group-fields clearfix row">
...
<br>
<h2 id="IL01">View Category</h2>
<form id="viewcategory" action="viewCategory.do" method="post">
